    ...
    <div class="col-md-6">
        ...
        <div class="block-web success-box">
            ...
            <div class="porlets-content">
                ...
                <p>Pertanyaan dan Informasi, silahkan kontak Panitia di giannugraha76@gmail.com (GTalk/Hangout) atau 081295704758!</p>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="border:0">
                                    <div class="text-primary"><strong>SPP (Sumbangan Pembinaan Pendidikan) 1</strong></div>
                                </td>
                            ...
                            <tr>
                                <td style="border:0">
                                    <div class="text-primary"><strong>Kirim Ke Rekening Ini</strong></div>
                                </td>
                                <td class="angka ssp" style="border:0">
                                    <div class="text-primary"><strong>1640002933119</strong></div>
                                </td>
                            </tr>
...
<div class="col-md-12 konfirm">
    <form role="form" action="transfer.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label>Nama Bank - Atas nama rekening (Contoh : Mandiri - Atas nama Gian Nugraha)</label>
            <div>
