...
//   $kode=$_POST['kode'];
  ...
  if($email===$konfirmemail){
    // if($_SESSION["Captcha"]==$kode){
        ...
        if(daftarformulir($nama,$tempat,$tglLahir,$jns_kel,$agama,$nohp,$alamat,$provinsi,$no_jaket,$email,$date)){
    ...
    <div class="row" style="margin-left:0;margin-right:0;">
        ...
        <div class="jumbotron daftar">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                   <!-- <label for="exampleInputEmail1">Tempat Lahir</label> <label title="contoh" style="background: blue; color: white; border-radius: 100px">?</label> -->
                    <label for="exampleInputEmail1">Tempat Lahir</label>
                    <input type="text" name="tempat" class="form-control" placeholder="Tempat Lahir" required>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Tanggal Lahir</label> <span style="color:red"><i>(Bulan, Hari, Tahun)</i></span>
        ...
        <div class="col-md-4" style="background-color: #E1F5A9; border-radius: 20px; margin-bottom: 30px">
        <div>
            <div class="header">
                <h3 style="color:black"><center>Halaman Admin</center></h3>
            </div>
            <hr style="border:1px solid black">
                <div class="form-group">
                    <a href="admin/login.php"><input type="submit" name="masuk" class="btn btn-block btn-success" value="Pergi"></a>
                </div>
        </div>
        </div>

        <div class="col-md-4" style="background-color: grey; border-radius: 20px">
            <div class="header">
                <h3 style="color:white"><center>Lokasi</center></h3>
            </div>
            <hr style="border:1px solid black">
            <div class="form-group">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.304297826663!2d107.8934897147745!3d-7.206083094797662!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68b0f80a2a80df%3A0xa679bbe9864c648b!2sSMK%20Ciledug%20Al-Musaddadiyah!5e0!3m2!1sid!2sid!4v1591328760216!5m2!1sid!2sid" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
